...
<title>Hong Kong 2025 · one month at a time</title>
...
<style>
  ...
  .kicker { margin: 0; color: #5C6C7C; font-size: 12px; letter-spacing: 0.12em;
            text-transform: uppercase; }
  h1 { margin: 0.3rem 0 0.5rem; color: #FFD9A0; font-weight: normal;
...
<div id="wrap">
  <header>
    <p class="kicker">SD5913 · Week 04 · one control, one response</p>
    <h1>Hong Kong, one month at a time</h1>
