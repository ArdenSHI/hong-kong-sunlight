...
<style>
  ...
  /* A marker pen, if the page can get one; someone's handwriting if it cannot. */
  #title text { font-family: "Permanent Marker", "Marker Felt", "Bradley Hand",
                "Ink Free", "Segoe Script", "Comic Sans MS", cursive; }
